...
LOG_DIR=/home/dsi/mishans1/projects/code_for_server_based/simulation/log_files/compare_networks/eval_log
CLAIM_DIR=/home/dsi/mishans1/projects/code_for_server_based/simulation/log_files/compare_networks/eval_claims
    ...
    while [ "$TASK_ID" -le "$END" ]; do
        ...
        if mkdir "$CLAIM_PATH" 2>/dev/null; then
            ...
            CUDA_VISIBLE_DEVICES=$GPU_ID SLURM_ARRAY_TASK_ID=$TASK_ID \
                python -u code_compare_results/evaluate_all_networks.py \
