...
from SmallFunctions import plot_architecture, crateNetworkConnaction, compere_all_stages, plotSNRvsBER, \
    save_var_with_name, plot_symbols
from Train_funcatios_clude import *
from GUI_input import get_parameters_gui_grouped, save_params_to_file, parse_params_txt
# Parameters0
